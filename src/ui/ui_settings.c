...
static const uint8_t main_menu[] = {
    8, 11, 19, 16, 22, 5, 5, 9, 3
};

static const UNIT_PARAM main_menu_items[] = {
    {"Настройка общие", 0, 0},
    {"Настройка таймеров", 0, 0},
    {"Настройка U гидpo.", 0, 0},
    {"Настройка P гидpo.", 0, 0},
    ...
    {"P09 форм в/д", "атм.", 0},
    {"P10 форм н/д", "атм.", 0},
    {"P11 страг загр", "атм.", 0},
    {"P12 ускор загр", "атм.", 0},
    {"P13 медл загр", "атм.", 0},
    {"P14 декомпр", "атм.", 0},
    {"Р15 паузы п/загр", "атм.", 0},
    {"P16 отвода МВ", "атм.", 0},
    {"P17 снятия", "атм.", 0}, 
    {"P18 отрыва", "атм.", 0},
    {"P19 ускор разм", "атм.", 0},
    {"P20 медл разм", "атм.", 0},
    {"P21 толк вперед", "атм.", 0},
    {"P22 толк назад", "атм.", 0},
